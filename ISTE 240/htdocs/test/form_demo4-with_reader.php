...
<h1>Form Demo v4: Styled with Bootstrap</h1>
<div>With Table Reader Demo</div>
...
<h2>Table Reader Demo</h2>
<div>Also styled with Bootstrap</div>

<?php
$file_open = fopen("data2.csv", "r");
